(function () {
  ...
  var fragSrc = [
    ...
    '',
    '  // The raised-cosine bump has zero slope right at each hill\'s radius, so',
    '  // elevation approaches 0 very slowly there — the ordinary elevation-',
    '  // threshold isoline above balloons into a wide band along the footprint',
    '  // edge no matter how small Line Width is set. Fade isolines out over the',
