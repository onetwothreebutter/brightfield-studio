(function () {
  ...
  var fragSrc = [
    ...
    '  // This line\'s thickness within the design\'s own top→bottom range.',
    '  float lineSpan = abs(u_width_bot - u_width_top);',
    '  float lineSize = lineSpan < 0.0001 ? 0.5',
    '                 : (lineWidth - min(u_width_top, u_width_bot)) / lineSpan;',
    ...
    '  finalPal = applyPaletteGroups(finalPal, lineSize, lineId);',
    '',
