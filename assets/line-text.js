(function () {
  ...
  var fragSrc = [
    ...
    '  float aa = max(fwidth(d) * 0.5, aaFixed);',
    ...
    '    // supersample) so dots shrink toward line edges instead of slicing.',
    ...
    '    col = dotColor;',
    '  } else {',
    '    alpha = applyDistress(px.a, dUV, u_distress, u_distress_scale, u_grain_mode, u_distress_falloff, dot(col, vec3(0.299, 0.587, 0.114)), vigMask) * u_opacity;',
    '  }',
