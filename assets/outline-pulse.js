(function () {
  ...
  var fragSrc = [
    ...
    '  float alpha;',
    '  if (u_grain_mode >= 3.5) {',
    '    // Half-tone: size each dot by ring-field coverage over its cell (3x3',
    '    // supersample) — classic halftone shading of the continuous ring bands,',
    '    // and dots shrink at the shirt silhouette instead of slicing.',
    ...
    '    alpha = px.a * u_opacity * distressMask;',
    '  }',
    '',
